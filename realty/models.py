...
class Product(models.Model):
    ...
    skype = models.URLField(max_length = 200, default='https://www.skype.com/en/', blank=True)
    instagram = models.URLField(max_length = 200, default='https://www.instagram.com/', blank=True)
    whatsapp = models.URLField(max_length = 200, default='https://www.whatsapp.com/?lang=es', blank=True)
...
class AboutSlideDown(models.Model):
...
class ReviewMy(models.Model):
    title = models.CharField('Title', max_length=50)
    full_text = models.TextField('Articl')
    image_avatar = models.ImageField('Image', null=True, blank=True, upload_to="images/", default='images/anonim.jpg')
...
class News_articl(models.Model):
    Business = 'business'
    Events = 'events'
    ...
    title = models.CharField('Title', max_length=50)
    mutetext = models.CharField('Mute', max_length=50)
    full_text = models.TextField('Articl', max_length=1000)
    categories = models.CharField(max_length=50, choices=NEWS_CATEGORIES, default=Events)
    date = models.DateTimeField('Publication date', null=True, blank=True)
    news_image = models.ImageField(
        'Image', null=True, blank=True, upload_to="images/", default='images/news.jpg')
